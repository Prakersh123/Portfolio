       ...
       <u> <h1  style={{textAlign:'center',margin:'20px', textShadow:' 3px 3px 6px  grey'}}>Education</h1></u>
        ...
        <div className="Education" id="education">
            <div className="eduDiv">
                    ...
                    <div style={{textAlign:'center'}} >
                    <h1><img className="edu_img" src=" https://heylangu.com/images/education-icon-home.svg?v=1548322879110"/></h1>
                    <h3>Sanatan Dharam Inter College, Varanasi</h3>

                    <h6>Higher Secondary Education, U.P.</h6>
                    </div>
                    <div style={{textAlign:'center'}} >
                    <h1><img className="edu_img" src="https://image.flaticon.com/icons/png/512/42/42972.png"/></h1>
